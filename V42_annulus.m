...
for i = 1:time_length
    ...
    FIELD = transient_field_annulus(DATA.step_duration,DISH.dish_power_pr_sqr_m(i),FIELD,DATA.wind_velocity(i),DATA.ambient_temp(i),DATA.humidity(i));
%         FIELD.RECEIVER
...
%                 FIELD.RECEIVER.mdot
%         FIELD.ANNULUS
%                 FIELD.ANNULUS.SECTION{}.tag
%                 FIELD.ANNULUS.SECTION{}.flow_multiplier
%                 FIELD.ANNULUS.SECTION{}.geometry
%                 FIELD.ANNULUS.SECTION{}.elbows
%                 FIELD.ANNULUS.SECTION{}.length
%                 FIELD.ANNULUS.SECTION{}.mesh
%                 FIELD.ANNULUS.SECTION{}.hot_temperature1
%                 FIELD.ANNULUS.SECTION{}.cold_temperature1
%                 FIELD.ANNULUS.SECTION{}.hot_temperature2
%                 FIELD.ANNULUS.SECTION{}.cold_temperature2
%                 FIELD.ANNULUS.SECTION{}.hot_pressure1
%                 FIELD.ANNULUS.SECTION{}.cold_pressure1
%                 FIELD.ANNULUS.SECTION{}.hot_pressure2
%                 FIELD.ANNULUS.SECTION{}.cold_pressure2
%                 FIELD.ANNULUS.SECTION{}.stainless_steel_cost
%                 FIELD.ANNULUS.SECTION{}.carbon_steel_cost
%                 FIELD.ANNULUS.SECTION{}.insulation1_cost
%                 FIELD.ANNULUS.SECTION{}.insulation2_cost
%                 FIELD.ANNULUS.SECTION{}.aluminium_cost
%                 FIELD.ANNULUS.SECTION{}.section_cost
%                 FIELD.ANNULUS.SECTION{}.sections_field_cost
%                 FIELD.ANNULUS.SECTION{}.dP_hot
%                 FIELD.ANNULUS.SECTION{}.dP_cold
%                 FIELD.ANNULUS.SECTION{}.dP_total
%             FIELD.ANNULUS.all_blowers_consumption
%             FIELD.ANNULUS.blower_consumption
%             FIELD.ANNULUS.dP_cluster
%             FIELD.ANNULUS.dP_blowers
%             FIELD.ANNULUS.dP_RECEIVER
%             FIELD.ANNULUS.dP_HEX
%             FIELD.ANNULUS.dt
%             FIELD.ANNULUS.dishes_in_field
%             FIELD.ANNULUS.clusters_in_field
%             FIELD.ANNULUS.dishes_per_cluster
%             FIELD.ANNULUS.pressure
%         FIELD.HEX
%                 FIELD.HEX.HP
...
%                         FIELD.POWER.consumption.All_pumps_consumption
        ...
        Tin_receiver(i) = FIELD.ANNULUS.SECTION{1}.cold_temperature1;
        Tout_receiver(i) = FIELD.ANNULUS.SECTION{1}.hot_temperature1;
        Tin_HEX(i) = FIELD.ANNULUS.SECTION{N}.hot_temperature2;
        Tout_HEX(i) = FIELD.ANNULUS.SECTION{N}.cold_temperature2;
        dP_cluster(i) = FIELD.ANNULUS.dP_cluster;
        mdot(i) = FIELD.RECEIVER.mdot;
        receiver_efficiency(i) = FIELD.RECEIVER.efficiency;
        dP_receiver(i) = FIELD.ANNULUS.dP_HEX;
        dP_HEX(i) = FIELD.ANNULUS.dP_RECEIVER;
        
         for j = 1:N
            Tout_HOT_sections(i,j) = FIELD.ANNULUS.SECTION{j}.hot_temperature2;
            dTinstruments_HOT_sections(i,j) = FIELD.ANNULUS.SECTION{j}.hot_temperature_loss_by_components;
            Tout_COLD_sections(i,j) = FIELD.ANNULUS.SECTION{j}.cold_temperature2;
            dTinstruments_COLD_sections(i,j) = FIELD.ANNULUS.SECTION{j}.cold_temperature_loss_by_components;
            dP_HOT_sections(i,j) = FIELD.ANNULUS.SECTION{j}.dP_hot;
            dP_COLD_sections(i,j) = FIELD.ANNULUS.SECTION{j}.dP_cold;
         end

        dP_blowers(i,1:size(FIELD.ANNULUS.dP_blowers,2)) = FIELD.ANNULUS.dP_blowers;
        blowers_consumption(i,1:size(FIELD.ANNULUS.blowers_consumption,2)) = FIELD.ANNULUS.blowers_consumption;
        all_blowers_consumption(i) = FIELD.ANNULUS.all_blowers_consumption;
        ...
        NET_Electric(i) = GROSS_Electric(i) - (ANNULUS.dishes_in_field.*DISH.consumption(i)+all_blowers_consumption(i)+all_pumps_consumption(i));
        ...
        G_all_blowers_consumption = FIELD.ANNULUS.all_blowers_consumption;
        G_all_pumps_consumption = FIELD.POWER.consumption.all_pumps_consumption;
        G_all_dishes_consumption = ANNULUS.dishes_in_field.*DISH.consumption(i);
        G_gross_electric = FIELD.POWER.Electric;
        G_net_electric = NET_Electric(i);
        
end

total_consumption = ANNULUS.dishes_in_field.*DISH.consumption + all_blowers_consumption' + all_pumps_consumption';
system_efficiency = NET_Electric'./(ANNULUS.dishes_in_field.*Dish_effective_Area.*DATA.DNI./1000);
...
xN_dishes_in_field = ['Number of Dishes in Field: ',num2cell(ANNULUS.dishes_in_field)]; % number of dishs in the field (minimum 1)
...
xHOT_ins1 = [['1st HOT Insulation Layer:' insulation_type_inv(INPUT.HTS_hot.insulation_material(1)) ', ' num2str(INPUT.HTS_hot.insulation_quality(1).*100) ' % Quality Occupation [%]: '],num2cell(INPUT.HTS_hot.insulation_occupation(1))]; % pipe cut area scalar
xHOT_ins2 = [['2nd HOT Insulation Layer:' insulation_type_inv(INPUT.HTS_hot.insulation_material(2)) ', ' num2str(INPUT.HTS_hot.insulation_quality(2).*100) ' % Quality Occupation [%]: '],num2cell(INPUT.HTS_hot.insulation_occupation(2))]; % inner insulation1 (MicroTherm) thickness / occupation of cross flow available [%]
xHOT_ins3 = [['3rd HOT Insulation Layer:' insulation_type_inv(INPUT.HTS_hot.insulation_material(3)) ', ' num2str(INPUT.HTS_hot.insulation_quality(3).*100) ' % Quality Occupation [%]: '],num2cell(INPUT.HTS_hot.insulation_occupation(3))]; % inner insulation2 thickness  / occupation of cross flow available [%]
xCOLD_ins1 = [['1st COLD Insulation Layer:' insulation_type_inv(INPUT.HTS_cold.insulation_material(1)) ', ' num2str(INPUT.HTS_cold.insulation_quality(1).*100) ' % Quality Occupation [m]: '],num2cell(INPUT.HTS_cold.insulation_thickness(1))]; % pipe cut area scalar
xCOLD_ins2 = [['2nd COLD Insulation Layer:' insulation_type_inv(INPUT.HTS_cold.insulation_material(2)) ', ' num2str(INPUT.HTS_cold.insulation_quality(2).*100) ' % Quality Occupation [m]: '],num2cell(INPUT.HTS_cold.insulation_thickness(2))]; % inner insulation1 (MicroTherm) thickness / occupation of cross flow available [%]
xCOLD_ins3 = [['3rd COLD Insulation Layer:' insulation_type_inv(INPUT.HTS_cold.insulation_material(3)) ', ' num2str(INPUT.HTS_cold.insulation_quality(3).*100) ' % Quality Occupation [m]: '],num2cell(INPUT.HTS_cold.insulation_thickness(3))]; % inner insulation2 thickness  / occupation of cross flow available [%]
if HTS_type==2
    HTS = ['After Each Dish'];
elseif HTS_type==3
    HTS = ['After Two Dishes'];
elseif HTS_type==1
    HTS = ['Separate ANNULUS'];
end
...
avg_system_efficiency = sum(NET_Electric)./sum(ANNULUS.dishes_in_field.*Dish_effective_Area.*DATA.DNI./1000);
...
design_FIELD = steady_field_annulus(design_DISH.dish_power_pr_sqr_m,FIELD,design_DATA.wind_velocity,design_DATA.ambient_temp,design_DATA.humidity);
        ...
        design_Tin_receiver = design_FIELD.ANNULUS.SECTION{1}.cold_temperature1; xdesign_Tin_receiver = ['Design Tin Receiver [*C]: ',num2cell(design_Tin_receiver)];
        design_Tout_receiver = design_FIELD.ANNULUS.SECTION{1}.hot_temperature1; xdesign_Tout_receiver = ['Design Tout Receiver [*C]: ',num2cell(design_Tout_receiver)];
        design_Tin_HEX = design_FIELD.ANNULUS.SECTION{N}.hot_temperature2; xdesign_Tin_HEX = ['Design Tin HEX [*C]: ',num2cell(design_Tin_HEX)];
        design_Tout_HEX = design_FIELD.ANNULUS.SECTION{N}.cold_temperature2; xdesign_Tout_HEX = ['Design Tout HEX [*C]: ',num2cell(design_Tout_HEX)];
        design_dP_cluster = 100000.*design_FIELD.ANNULUS.dP_cluster; xdesign_dP_cluster = ['Design Cluster dP [Pa]: ',num2cell(design_dP_cluster)];
        ...
        design_dP_receiver = 100000.*design_FIELD.ANNULUS.dP_HEX; xdesign_dP_receiver = ['Design Receiver dP [Pa]: ',num2cell(design_dP_receiver)];
        design_dP_HEX = 100000.*design_FIELD.ANNULUS.dP_HEX; xdesign_dP_HEX = ['Design HEX dP [Pa]: ',num2cell(design_dP_HEX)];
        xtitle = {'Annulus Endpoints: ',''};
        
xSUMMARY_Annulus_Points = [xtitle;xdesign_mdot;xdesign_receiver_efficiency;xdesign_Tin_receiver;xdesign_Tout_receiver;xdesign_dP_receiver;xdesign_Tin_HEX;xdesign_Tout_HEX;xdesign_dP_HEX;xdesign_dP_cluster]; % 10 x 2
              
        design_Tout_Receiver = design_FIELD.ANNULUS.SECTION{1}.hot_temperature1;
        design_Tin_Receiver = design_FIELD.ANNULUS.SECTION{1}.cold_temperature1;        
        
         for j = 1:N
            design_Tout_HOT_sections(j) = design_FIELD.ANNULUS.SECTION{j}.hot_temperature2; 
            design_dTinstruments_HOT_sections(j) = design_FIELD.ANNULUS.SECTION{j}.hot_temperature_loss_by_components;
            design_Tout_COLD_sections(j) = design_FIELD.ANNULUS.SECTION{j}.cold_temperature2; 
            design_dTinstruments_COLD_sections(j) = design_FIELD.ANNULUS.SECTION{j}.cold_temperature_loss_by_components;
            design_dP_HOT_sections(j) = 100000.*design_FIELD.ANNULUS.SECTION{j}.dP_hot; 
            design_dP_COLD_sections(j) = 100000.*design_FIELD.ANNULUS.SECTION{j}.dP_cold; 
            length(j) = design_FIELD.ANNULUS.SECTION{j}.length; 
            hot_elbows(j) = design_FIELD.ANNULUS.SECTION{j}.hot_elbows; 
            cold_elbows(j) = design_FIELD.ANNULUS.SECTION{j}.cold_elbows; 
            tag(j) = {design_FIELD.ANNULUS.SECTION{j}.tag};
         end
         ...
         xtitle = ['Annulus Sections: ',num2cell(nan(1,N+1))];
         
xSUMMARY_Annulus_Sections = [xtitle;xdesign_section_tag;xsection_length;xdesign_section_hot_elbows;xdesign_section_cold_elbows;xdesign_Tout_HOT_sections;xdesign_dTinstruments_HOT_sections;xdesign_Tout_COLD_sections;xdesign_dTinstruments_COLD_sections;xdesign_dP_HOT_sections;xdesign_dP_COLD_sections]; % 8xN+1

        design_dP_blowers(1,1:size(design_FIELD.ANNULUS.dP_blowers,2)) = 100000.*design_FIELD.ANNULUS.dP_blowers; 
        p1 = ['Design Blowers {'  num2str(size(design_FIELD.ANNULUS.dP_blowers,2)) '} dP [Pa]: '];
        xdesign_dP_blowers = [p1,num2cell(design_dP_blowers)];
        design_blowers_consumption(1,1:size(design_FIELD.ANNULUS.blowers_consumption,2)) = design_FIELD.ANNULUS.blowers_consumption;
        p2 = ['Design Blowers {' num2str(size(design_FIELD.ANNULUS.dP_blowers,2)) '} Consumption [KW]: '];
        xdesign_blowers_consumption = [p2,num2cell(design_blowers_consumption)];
        design_all_blowers_consumption = design_FIELD.ANNULUS.all_blowers_consumption;
        xdesign_all_blowers_consumption = ['Design Blowers Consumption (tot) [KW]: ',num2cell(design_all_blowers_consumption),num2cell(nan(1,size(design_FIELD.ANNULUS.blowers_consumption,2)-1))];
        xtitle = ['Blowers: ',num2cell(nan(1,size(design_FIELD.ANNULUS.dP_blowers,2)))];
...
xSUMMARY_Blowers = [xtitle;xdesign_dP_blowers;xdesign_blowers_consumption;xdesign_all_blowers_consumption]; % 4 x Number of clusters
        ...
        design_NET_Electric = design_GROSS_Electric - (ANNULUS.dishes_in_field.*design_DISH.consumption+design_all_blowers_consumption+design_all_pumps_consumption); xdesign_NET_Electric = ['Installed Capacity (NET design) [KWe]: ',num2cell(design_NET_Electric)];
        design_system_efficiency = design_NET_Electric./(ANNULUS.dishes_in_field.*design_DATA.DNI.*Dish_effective_Area./1000); xdesign_system_efficiency = ['Design System Efficiency: ',num2cell(design_system_efficiency)];
...
[status,msginfo] = xlswrite(file_name,xSUMMARY_Annulus_Points,'SUMMARY','D11');
[status,msginfo] = xlswrite(file_name,xSUMMARY_Blowers,'SUMMARY','D22');
[status,msginfo] = xlswrite(file_name,xSUMMARY_Annulus_Sections,'SUMMARY','D27');
...
xall_dishes_consumption = ['All Dishes Consumption [KW]';num2cell(DISH.consumption.*ANNULUS.dishes_in_field)];
...
for j = 1:N
        ...
        xTout_HOT_sections(:,j) =  ['Section ' FIELD.ANNULUS.SECTION{j}.tag ' Thot out [*C]';num2cell(Tout_HOT_sections(:,j))];
        xdTinstruments_HOT_sections(:,j) =  ['Section ' FIELD.ANNULUS.SECTION{j}.tag ' Hot Instruments Loss [*C]';num2cell(dTinstruments_HOT_sections(:,j))];
        xTout_COLD_sections(:,j) =  ['Section ' FIELD.ANNULUS.SECTION{j}.tag ' Tcold in [*C]';num2cell(Tout_COLD_sections(:,j))];
        xdTinstruments_COLD_sections(:,j) =  ['Section ' FIELD.ANNULUS.SECTION{j}.tag ' Cold Instruments Loss [*C]';num2cell(dTinstruments_COLD_sections(:,j))];
        xdP_HOT_sections(:,j) = ['Section ' FIELD.ANNULUS.SECTION{j}.tag ' hot dP [Pa]';num2cell(100000.*dP_HOT_sections(:,j))];
        xdP_COLD_sections(:,j) = ['Section ' FIELD.ANNULUS.SECTION{j}.tag ' cold dP [Pa]';num2cell(100000.*dP_COLD_sections(:,j))];
...
for k = 1:size(FIELD.ANNULUS.dP_blowers,2)
...
xANNULUS = [xmdot,xTout_receiver,xTout_HOT_sections,xTin_receiver,xTout_COLD_sections,...
...
xCOST_single_dish_cost = ['Single Dish Cost [$]:',num2cell(ANNULUS.single_dish_cost)];
xCOST_all_dishes_cost = [[num2str(ANNULUS.dishes_in_field) ' Dishes in the Field - Total Cost [$]:'],num2cell(ANNULUS.all_dishes_cost)];
xCOST_steam_cycle_cost = ['Steam Cycle Cost [$]:',num2cell(ANNULUS.steam_cycle_cost)];
xCOST_power_unit_cost = ['Power Unit Cost [$]:',num2cell(ANNULUS.power_unit_cost)];
xCOST_pumps_cost = ['Pumps Cost [$]:',num2cell(ANNULUS.pumps_cost)];
xCOST_water_treatment_system_cost = ['Water Treatment System Cost [$]:',num2cell(ANNULUS.water_treatment_system_cost)];
xCOST_air_system_cost = ['Air System Cost [$]:',num2cell(ANNULUS.air_system_cost)];
xCOST_blowers_cost = ['Blowers Cost [$]:',num2cell(ANNULUS.blowers_cost)];
xCOST_Instruments_cost = ['Instruments Cost [$]:',num2cell(ANNULUS.Instruments_cost)];
xCOST_control_cost = ['Control System Cost [$]:',num2cell(ANNULUS.control_cost)];
xCOST_other_essentials_cost = ['Other Essentials Cost [$]:',num2cell(ANNULUS.other_essentials_cost)];
xCOST_all_annulus_cost = ['HTS (Annulus) Cost [$]:',num2cell(ANNULUS.all_annulus_cost)];
xCOST_project_cost = ['Project (tot) Cost [$]:',num2cell(ANNULUS.project_cost)];
...
xCOST = [xCOST_single_dish_cost;xCOST_all_dishes_cost;xCOST_steam_cycle_cost;xCOST_power_unit_cost;...
    ...
    xCOST_Instruments_cost;xCOST_control_cost;xCOST_other_essentials_cost;xCOST_all_annulus_cost;...
    xCOST_project_cost];

% annulus:  x-number of dishes in field



for i = 1:N
    tagC(i) = {design_FIELD.ANNULUS.SECTION{i}.tag};
    Length_L(i) = FIELD.ANNULUS.SECTION{i}.length;
    Radii(:,i) = FIELD.ANNULUS.SECTION{i}.geometry';
    COST_L_stainless_steel(i) = FIELD.ANNULUS.SECTION{i}.stainless_steel_cost;
    COST_L_carbon_steel(i) = FIELD.ANNULUS.SECTION{i}.carbon_steel_cost;
    COST_L_hot_insulation1(i) = FIELD.ANNULUS.SECTION{i}.hot_insulation1_cost;
    COST_L_hot_insulation2(i) = FIELD.ANNULUS.SECTION{i}.hot_insulation2_cost;
    COST_L_hot_insulation3(i) = FIELD.ANNULUS.SECTION{i}.hot_insulation3_cost;
    COST_L_aluminium(i) = FIELD.ANNULUS.SECTION{i}.aluminium_cost;
    COST_L_cold_insulation1(i) = FIELD.ANNULUS.SECTION{i}.cold_insulation1_cost;
    COST_L_cold_insulation2(i) = FIELD.ANNULUS.SECTION{i}.cold_insulation2_cost;
    COST_L_cold_insulation3(i) = FIELD.ANNULUS.SECTION{i}.cold_insulation3_cost;
    COST_L_section_cost(i) = FIELD.ANNULUS.SECTION{i}.section_cost;
    COST_L_sections_field(i) = FIELD.ANNULUS.SECTION{i}.sections_field_cost;
    COST_1m_stainless_steel(i) = FIELD.ANNULUS.SECTION{i}.stainless_steel_cost./Length_L(i);
    COST_1m_carbon_steel(i) = FIELD.ANNULUS.SECTION{i}.carbon_steel_cost./Length_L(i);
    COST_1m_hot_insulation1(i) = FIELD.ANNULUS.SECTION{i}.hot_insulation1_cost./Length_L(i);
    COST_1m_hot_insulation2(i) = FIELD.ANNULUS.SECTION{i}.hot_insulation2_cost./Length_L(i);
    COST_1m_hot_insulation3(i) = FIELD.ANNULUS.SECTION{i}.hot_insulation3_cost./Length_L(i);
    COST_1m_aluminium(i) = FIELD.ANNULUS.SECTION{i}.aluminium_cost./Length_L(i);
    COST_1m_cold_insulation1(i) = FIELD.ANNULUS.SECTION{i}.cold_insulation1_cost./Length_L(i);
    COST_1m_cold_insulation2(i) = FIELD.ANNULUS.SECTION{i}.cold_insulation2_cost./Length_L(i);
    COST_1m_cold_insulation3(i) = FIELD.ANNULUS.SECTION{i}.cold_insulation3_cost./Length_L(i);
    COST_1m_section_cost(i) = FIELD.ANNULUS.SECTION{i}.section_cost./Length_L(i);
    COST_1m_sections_field(i) = FIELD.ANNULUS.SECTION{i}.sections_field_cost./Length_L(i);
    cold_bypasses(i) = ANNULUS.SECTION{i}.cold_bypasses;
    cold_bypass_length(i) = ANNULUS.SECTION{i}.cold_bypass_length;
    cold_bypass_thickness(i) = ANNULUS.SECTION{i}.cold_bypass_thickness;
end
...
for p = 1:2.*N
    if p./2==ceil(p./2)
        ...
        Radiix(:,p) = num2cell(Radii(:,p./2));
        Diax(:,p) = num2cell(2.*Radii(:,p./2));
...
xRadiix = [{'R inner pipe in [m]: ';'R inner pipe out [m]: ';'R inner insulation 1 [m]: ';'R inner insulation 2 [m]: ';'R inner insulation 3 [m]: ';'R oter pipe in [m]: ';'R outer pipe out [m]: ';'R outer insulation 1 [m]: ';'R outer insulation 2 [m]: ';'R outer insulation 3 [m]: '},Radiix];
xDiax = [{'D inner pipe in [m]: ';'D inner pipe out [m]: ';'D inner insulation 1 [m]: ';'D inner insulation 2 [m]: ';'D inner insulation 3 [m]: ';'D oter pipe in [m]: ';'D outer pipe out [m]: ';'D outer insulation 1 [m]: ';'D outer insulation 2 [m]: ';'D outer insulation 3 [m]: '},Diax];
...
xCOST_Annulus = [xtag;xNelements;xLength;xRadiix;xDiax;xxcold_bypasses;xxcold_bypass_length;xxcold_bypass_thickness;xCOST_stainless_steel;...
...
[status,msginfo] = xlswrite(file_name,[xDATA,xANNULUS],'ANNULUS','A3');
[status,msginfo] = xlswrite(file_name,[xDATA,xPB],'HEX','A3');
[status,msginfo] = xlswrite(file_name,xCOST,'COST','A3');
[status,msginfo] = xlswrite(file_name,xCOST_Annulus,'COST','A17');
t = toc./60
...
[status,msginfo] = xlswrite(file_name,HF_title,'ANNULUS','A1');
[status,msginfo] = xlswrite(file_name,HF_title,'HEX','A1');
[status,msginfo] = xlswrite(file_name,HF_title,'COST','A1');

OPT_title = {'Project Cost [$]: ' num2str(ANNULUS.project_cost),'','Net Power [KWh]: ' num2str(tot_NET),'','Optimization Criterion [Net(KWh.e)/Cost($)] : ' num2str(tot_NET/ANNULUS.project_cost)};
...
[status,msginfo] = xlswrite(file_name,OPT_title,'ANNULUS','A2');
